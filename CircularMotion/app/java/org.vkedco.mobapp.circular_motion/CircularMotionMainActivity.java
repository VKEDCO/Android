...
public class CircularMotionMainActivity extends Activity {
	...
	class PainterRunnable implements Runnable {
		...
		public PainterRunnable(Circle c) {
			mCircle = c;
		}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_tuneup) {
			...
			Log.v("MainAct_TAG", mRes.getString(R.string.red_amp) + "="+ mPainterView.getRedRho());
			Log.v("MainAct_TAG", mRes.getString(R.string.blue_amp) + "="+ mPainterView.getBlueRho());
			Log.v("MainAct_TAG", mRes.getString(R.string.magenta_amp) + "="+ mPainterView.getMagentaRho());
			Log.v("MainAct_TAG", mRes.getString(R.string.yellow_amp) + "="+ mPainterView.getYellowRho());
	...
	private void startUnsynchronizedThreads() {
		...
		for(Circle c: mPainterView.getCircles()) {
			th = new Thread(new PainterRunnable(c));
