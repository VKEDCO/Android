...
/*************************************************
 * RotatingCircle class defines Circle objects drawn
 * by CircularMotionPainterView defined in CircularMotionPainterView.java.
 * These circles rotate on the left side of the view
...
public class RotatingCircle extends Circle {
	...
	public RotatingCircle(float x, float y, float r, Paint p) {
		super(x, y, r, p);
	}
	...
	public RotatingCircle(float mc_x, float mc_y, float mc_r,
	...
	public void move() {
		...
		recalculateCenterXY();
		if ( mSinosoidCircle != null ) {
			mSinosoidCircle.move(this);
		}
	}
	...
	public static double calculateCircularDistance(int hz) {
		return 2*Math.PI*hz;
	}
	
	public static double calculateRadThetaDelta(int hz, int avrg_fps, int rot_dir) {
		return rot_dir*calculateCircularDistance(hz)/avrg_fps;
	}
	...
	public void setSinosoidCircle(SinusoidCircle sc) {
		mSinosoidCircle = sc;
	}
	
	public int getRotDir() { return mRotDir; }
	
	public SinusoidCircle getSinosoidCircle() { return mSinosoidCircle; }	
	
	// maximum period of the motion circle is the number of maximum rho's *
	// the value of mRhoMax;
	...
	// number of rhos in the maximum period is the
	// value of the maximum period divided by the value of
	// mRho.
	...
	// the period of the circle is 4 * mRho. 
